...
### Fixed
- All `qdbus` calls replaced with `qdbus6` following Qt5 removal from base system. Affects language changer (keyboard layout reset, Plasma shell refresh) and session manager (KDE logout script).
